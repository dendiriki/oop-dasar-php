...
class Produk {
    ...
    public function __construct($judul, $penulis, $penerbit, $harga = 0, $jmlhalman = 0, $waktumain =0) {
        $this->judul = $judul;
    ...
    class Komik extends Produk{
        public function getinfokomik(){
            $str = "Komik : {$this->judul} | {$this->getlebel()} (Rp. {$this->harga}) - {$this->jmlhalman} Halaman.";
            return $str;
        }
    }
    ...
    class Game extends Produk{
        public function getinfogame(){
            $str = "Game : {$this->judul} | {$this->getlebel()} (Rp. {$this->harga}) - {$this->waktumain} Waktu Main Game.";
            return $str;
        }
    }
